...
(function(root, factory) {
  ...
  define("dollar-builtin", [], function() {
    ...
    function each(obj, iterator) {
      ...
      if (typeof obj !== "function" && typeof obj.length === "number") {
        ...
        for (i in obj) {
          if (
            hasOwn.call(obj, i) &&
            iterator.call(obj[i], i, obj[i]) === false
          ) {
            return obj;
          }
        }
    ...
    function $(elem) {
      ...
      elem =
        typeof elem === "string" && rId.test(elem)
          ? doc.getElementById(RegExp.$1)
          : elem;
  ...
  define("dollar", ["dollar-builtin"], function($) {
    return $;
  });
  /**
   * 直接来源于jquery的代码。
    ...
    api = {
      ...
      when: function(subordinate /* , ..., subordinateN */) {
        var i = 0,
          ...
          remaining =
            length !== 1 || (subordinate && $.isFunction(subordinate.promise))
              ? length
              : 0,
  ...
  define("lib/filepicker", [
    ...
    Base.inherits(RuntimeClient, {
      ...
      refresh: function() {
        var shimContainer = this.getRuntime().getContainer(),
          ...
          /*
                    ...
                    */
          width =
            (button[0] && button[0].offsetWidth) ||
            button.outerWidth() ||
            button.width(),
          height =
            (button[0] && button[0].offsetHeight) ||
            button.outerHeight() ||
            button.height(),
          pos = button.offset();
      ...
      destroy: function() {
        ...
        btn.removeClass(
          "webuploader-pick-disable webuploader-pick-hover " +
            "webuploader-pick"
        );
      }
    });
      ...
      _doSend: function(block) {
        ...
        tr.on("error", function(type, flag) {
          ...
          var typeArr = type.split("|"),
            ...
            statusText;
          type = typeArr[0];
          (status = parseFloat(typeArr[1])), (statusText = typeArr[2]);
          ...
          if (
            block.chunks > 1 &&
            ~"http,abort,server".indexOf(type.replace(/-.*/, "")) &&
    ...
    return Html5Runtime.register("Transport", {
      ...
      send: function() {
        ...
        if (opts.sendAsBinary) {
          server +=
            opts.attachInfoToQuery !== false
              ? (/\?/.test(server) ? "&" : "?") + $.param(owner._formData)
              : "";
      ...
      _parseHeader: function(raw) {
        ...
        raw &&
          raw.replace(/^([^\:]+):(.*)$/gm, function(_, key, value) {
